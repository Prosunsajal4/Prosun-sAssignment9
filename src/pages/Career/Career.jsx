      ...
      <div className="rounded-3xl bg-white p-8 shadow-sm ring-1 ring-slate-100">
        ...
        <div className="mt-6 space-y-4">
          {paths.map(({ icon: Icon, title, description, tag, skills }) => (
            <div
              key={title}
              className="group rounded-2xl border border-slate-100 bg-slate-50 p-6 transition-all hover:bg-white hover:shadow-md hover:border-indigo-100"
            >
                ...
                <div className="flex-1">
                  ...
                  <div className="mt-3 flex flex-wrap gap-2">
                    {skills.map((skill) => (
                      <span
                        key={skill}
                        className="rounded-lg bg-white border border-slate-200 px-2.5 py-1 text-xs text-slate-600"
                      >
                        {skill}
                      </span>
                    ))}
